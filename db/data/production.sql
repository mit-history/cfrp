...
--
-- Name: registers_author1_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_author1_index AS
 SELECT plays.author AS author1,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (((public.registers
     JOIN public.register_plays ON ((register_plays.register_id = registers.id)))
     JOIN public.plays ON ((plays.id = register_plays.play_id)))
     JOIN public.register_plays register_plays_registers ON ((register_plays_registers.register_id = registers.id)))
  WHERE (register_plays.ordering = 1)
  GROUP BY plays.author
  WITH NO DATA;


ALTER TABLE registers_author1_index OWNER TO jamie;

--
-- Name: registers_author2_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_author2_index AS
 SELECT plays.author AS author2,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (((public.registers
     JOIN public.register_plays ON ((register_plays.register_id = registers.id)))
     JOIN public.plays ON ((plays.id = register_plays.play_id)))
     JOIN public.register_plays register_plays_registers ON ((register_plays_registers.register_id = registers.id)))
  WHERE (register_plays.ordering = 2)
  GROUP BY plays.author
  WITH NO DATA;


ALTER TABLE registers_author2_index OWNER TO jamie;

--
-- Name: registers_genre1_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_genre1_index AS
 SELECT plays.genre AS genre1,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (((public.registers
     JOIN public.register_plays ON ((register_plays.register_id = registers.id)))
     ...
     JOIN public.register_plays register_plays_registers ON ((register_plays_registers.register_id = registers.id)))
  WHERE (register_plays.ordering = 1)
  GROUP BY plays.genre
  WITH NO DATA;


ALTER TABLE registers_genre1_index OWNER TO jamie;

--
-- Name: registers_genre2_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_genre2_index AS
 SELECT plays.genre AS genre2,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (((public.registers
     JOIN public.register_plays ON ((register_plays.register_id = registers.id)))
...
ALTER TABLE registers_genre2_index OWNER TO jamie;
...
--
-- Name: registers_parterre_receipts_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_parterre_receipts_index AS
 SELECT (public.bucket((amalgamated_sales.receipts)::double precision, 100, '0999'::text, 'Inconnu'::text) || ' l.'::text) AS parterre_receipts,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (public.registers
     JOIN public.amalgamated_sales ON ((registers.id = amalgamated_sales.register_id)))
  WHERE (amalgamated_sales.section = 'parterre'::text)
  GROUP BY (public.bucket((amalgamated_sales.receipts)::double precision, 100, '0999'::text, 'Inconnu'::text) || ' l.'::text)
  WITH NO DATA;


ALTER TABLE registers_parterre_receipts_index OWNER TO jamie;

--
-- Name: registers_premiere_loge_receipts_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_premiere_loge_receipts_index AS
 SELECT (public.bucket((amalgamated_sales.receipts)::double precision, 100, '0999'::text, 'Inconnu'::text) || ' l.'::text) AS premiere_loge_receipts,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (public.registers
     JOIN public.amalgamated_sales ON ((registers.id = amalgamated_sales.register_id)))
  WHERE (amalgamated_sales.section = 'premiere-loge'::text)
  GROUP BY (public.bucket((amalgamated_sales.receipts)::double precision, 100, '0999'::text, 'Inconnu'::text) || ' l.'::text)
  WITH NO DATA;


ALTER TABLE registers_premiere_loge_receipts_index OWNER TO jamie;

--
-- Name: registers_season_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_season_index AS
 SELECT registers.season,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM public.registers
  GROUP BY registers.season
  WITH NO DATA;


ALTER TABLE registers_season_index OWNER TO jamie;

--
-- Name: registers_title1_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_title1_index AS
 SELECT plays.title AS title1,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (((public.registers
     JOIN public.register_plays ON ((register_plays.register_id = registers.id)))
...
ALTER TABLE registers_title1_index OWNER TO jamie;

--
-- Name: registers_title2_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_title2_index AS
 SELECT plays.title AS title2,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM (((public.registers
     JOIN public.register_plays ON ((register_plays.register_id = registers.id)))
...
ALTER TABLE registers_title2_index OWNER TO jamie;

--
-- Name: registers_total_receipts_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_total_receipts_index AS
 SELECT (public.bucket((registers.total_receipts_recorded_l)::double precision, 100, '0999'::text, 'Inconnu'::text) || ' l.'::text) AS total_receipts,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM public.registers
  GROUP BY (public.bucket((registers.total_receipts_recorded_l)::double precision, 100, '0999'::text, 'Inconnu'::text) || ' l.'::text)
  WITH NO DATA;


ALTER TABLE registers_total_receipts_index OWNER TO jamie;

--
-- Name: registers_weekday_index; Type: MATERIALIZED VIEW; Schema: facet; Owner: jamie
--

CREATE MATERIALIZED VIEW registers_weekday_index AS
 SELECT registers.weekday,
    signature(registers._packed_id) AS signature,
    now() AS updated_at
   FROM public.registers
  GROUP BY registers.weekday
  WITH NO DATA;


ALTER TABLE registers_weekday_index OWNER TO jamie;
...
--
-- Name: plays_dim_season_creation_idx; Type: INDEX; Schema: warehouse; Owner: jamie
--

CREATE INDEX plays_dim_season_creation_idx ON play_dim USING btree (cfrp_season(date_de_creation));
