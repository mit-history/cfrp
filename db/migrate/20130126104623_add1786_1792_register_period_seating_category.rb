# -*- coding: utf-8 -*-
class Add17861792RegisterPeriodSeatingCategory < ActiveRecord::Migration
  SEATING_CATEGORIES = ['Premieres Loges à 6 places, à 6 liv.',
                        ...
                        'Quatriemes Loges à 4 places, à 3 l. 15 s.',
                        'Quatriemes Loges à 3 places, à 3 l. 15 s.',
  ...
  def up
    rp = RegisterPeriod.new(:period => '1786 to 1792')
    rp.save
  ...
  def down
    rp = RegisterPeriod.find_by_period('1786 to 1792')
